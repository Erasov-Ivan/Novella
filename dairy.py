...
class Dairy:
    def __init__(
        ...
        self.plot = Plot(
            plot={
                'Глава 1': [
                    'Ну тут какой нибудь текст описания и всё такое',
                    'Потом ещё текст',
                    '',
                    'А потом ещё целый абзац там туда сюда'
                ],
                'Глава 2': [
                    'А тут уже другой текст потому что другая глава',
                    'Потом ещё текст',
                    '',
                    'А потом ещё целый абзац там туда сюда',
                    '',
                    'А в этой главе например вообще 3 абзаца'
                ]
            },
